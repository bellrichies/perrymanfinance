...
export function Header() {
  ...
  return <header className="sticky top-0 z-20 border-b border-white/10 bg-[#030812]/90 text-white backdrop-blur">
    <div className="mx-auto flex max-w-7xl items-center justify-between gap-6 px-6 py-5">
      ...
      <div className="hidden items-center gap-3 md:flex"><Link className="px-4 py-2 text-sm font-semibold text-slate-200 hover:text-white" to="/admin/login">Login</Link></div>
